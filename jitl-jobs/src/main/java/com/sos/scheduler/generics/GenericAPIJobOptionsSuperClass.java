...
public class GenericAPIJobOptionsSuperClass extends JSOptionsClass {
    ...
    @JSOptionDefinition(name = "javaClassName", description = "The Name of the Java Class (e.g. a JS Adapter Class) which has to be e",
            key = "javaClassName", type = "SOSOptionString", mandatory = true)
