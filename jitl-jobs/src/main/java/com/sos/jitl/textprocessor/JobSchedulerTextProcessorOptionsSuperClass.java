...
/**
 * \var command : 
 * Command: count: counts the hits of a string add: adds a string at the end of the file. read: reads line -n. Possible value for n are numbers and first/last The command can contain the param. Samples: count test add xxxx read 6 read last
 *
 */
    @JSOptionDefinition(name = "command", 
    description = "", 
    key = "command", 
 ...
 *
 */
    @JSOptionDefinition(name = "filename", 
    description = "", 
    key = "filename", 
    type = "SOSOptionString", 
    mandatory = true)
 ...
 *
 */
    @JSOptionDefinition(name = "result", 
    description = "", 
    key = "result", 
    type = "SOSOptionString", 
    mandatory = false)
...
/**
 * \var scheduler_textprocessor_result : 
 * Command: Return value: count: counted number of char countCaseSensitive: counted number of char add: param read: the readed line insert: param
 *
 */
    @JSOptionDefinition(name = "scheduler_textprocessor_result", 
    description = "", 
    key = "scheduler_textprocessor_result", 
    type = "SOSOptionString", 
    mandatory = false)
