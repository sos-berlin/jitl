...
public class JobSchedulerCheckBlacklistOptionsSuperClass extends JSOptionsClass {
    ...
    /** \var granuality : Defines the start of the job or the job_chain order:
     * for each order that is in a blacklist jobchain: for each job chain that
     * has a blacklist. blacklist: One start when a blacklist exists. */
    ...
    /** \var job : The name of the job that should be startet Parameters of the
     * job filename: name of the file that is in the blacklist job_chain: name
     * of the job_chain that has a blacklist. created: creation time of the
     ...
     * The name of the job chain that should be startet Parameters of the order
     * filename: name of the file that is in the blacklist job_chain: name of
     * the job_chain that has a blacklist. created: creation time of the order
     * which is in the blacklist */
    @JSOptionDefinition(name = "job_chain", description = "The name of the job chain that should be startet Paramet", key = "job_chain", type = "SOSOptionString", mandatory = false)
    ...
    /** \brief getjob_chain : The name of the job chain that should be startet
     * Paramet
     * 
    ...
    /** \brief setjob_chain : The name of the job chain that should be startet
     * Paramet
     * 
     * \details The name of the job chain that should be startet Parameters of
     * the order filename: name of the file that is in the blacklist job_chain:
     ...
     * order which is in the blacklist
     *
     * @param job_chain : The name of the job chain that should be startet
     *            Paramet */
    ...
    /** \var level : Specifies the log entry info: a info entry will be made
     * warning: a warn entry will be made error: an error entry will be made */
