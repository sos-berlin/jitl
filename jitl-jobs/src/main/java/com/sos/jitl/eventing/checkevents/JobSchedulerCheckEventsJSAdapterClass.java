...
public class JobSchedulerCheckEventsJSAdapterClass extends JobSchedulerJobAdapter {
    ...
    private void doProcessing() throws Exception {
        ...
        success = (objR.exist && objO.handle_existing_as.Value().equals("success") || !objR.exist && objO.handle_not_existing_as.Value().equals("success")
                || objR.exist && objO.handle_not_existing_as.Value().equals("error") || !objR.exist && objO.handle_existing_as.Value().equals("error") || objR.exist
                && !objO.handle_existing_as.isDirty());
        if (success) {
