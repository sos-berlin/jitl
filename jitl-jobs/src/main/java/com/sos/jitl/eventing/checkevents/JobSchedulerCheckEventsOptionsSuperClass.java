 ...
 * by the "real" Options-class (\see JobSchedulerCheckEventsOptions. The "real"
 ...
 *
 * 
 * \verbatim ; \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 * 
 ...
 * ("		JobSchedulerCheckEventsOptionsSuperClass.auth_file", "test"); // This
...
public class JobSchedulerCheckEventsOptionsSuperClass extends JSOptionsClass {
    ...
    @JSOptionDefinition(name = "handle_not_existing_as", description = "", key = "handle_not_existing_as", type = "SOSOptionString", mandatory = false)
