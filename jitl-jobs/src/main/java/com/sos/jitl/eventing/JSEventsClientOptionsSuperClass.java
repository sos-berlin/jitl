 ...
 * by the "real" Options-class (\see JSEventsClientOptions. The "real" Option
 ...
 * latestscheduler\config\JOETemplates\java\xsl\JSJobDoc2JSOptionSuperClass.xsl
 * from http://www.sos-berlin.com at 20130109134235 \endverbatim \section
 ...
 * ("		JSEventsClientOptionsSuperClass.auth_file", "test"); // This parameter
...
public class JSEventsClientOptionsSuperClass extends JSOptionsClass implements ISOSSchedulerSocket {
    ...
    /** \option Event_Parameter \type SOSOptionString \brief Event_Parameter -
     * Parameters which will pass to the event
     *
     * \details The Name of the Params which will passed to the events.
     *
     * \mandatory: false
     *
    ...
    /** \var scheduler_event_action : Action to be performed: add - add Event
     * remove - remove Event(s) When removing an event, the parameters
     * scheduler_event_job scheduler_event_host scheduler_event_port
     * scheduler_event_exit_code (along with the parameters which are used for
     * adding) can be used to specify the event. */
    ...
    /** \var scheduler_event_exit_code : JobName for which the event is valid */
    ...
    /** \var scheduler_event_expiration_cycle : Similar to
     * scheduler_event_expiration_period this parameter specifies a time (e.g.
     * 06:00) when an event will expire. scheduler_event_expiration_cycle takes
     * precedence over scheduler_event_expiration_period . */
    ...
    /** \var scheduler_event_expiration_period : This parameter specifies an
     * expiration period for events. */
    ...
    /** \var scheduler_event_expires : Expiration date of the event (ISO-format
    ...
    /** \var scheduler_event_id : Event ID (arbitrary) */
    ...
    /** \var supervisor_job_chain : Jobchain for processing events in the
     * supervisor */
