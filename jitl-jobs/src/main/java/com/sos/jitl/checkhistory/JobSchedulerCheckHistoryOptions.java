...
public class JobSchedulerCheckHistoryOptions extends JobSchedulerCheckHistoryOptionsSuperClass {
    ...
    public JobSchedulerCheckHistoryOptions() {
    }

    public JobSchedulerCheckHistoryOptions(JSListener pobjListener) {
        this();
        this.registerMessageListener(pobjListener);
    }

    public JobSchedulerCheckHistoryOptions(HashMap<String, String> JSSettings) throws Exception {
        super(JSSettings);
    }
