...
public class SOSMailProcessInboxJSAdapterClass extends JobSchedulerJobAdapter {
    ...
    private void doProcessing() throws Exception {
        ...
        sosMailProcessInboxOptions.setCurrentNodeName(this.getCurrentNodeName(getSpoolerProcess().getOrder(), true));
        sosMailProcessInboxOptions.setAllOptions(getSchedulerParameterAsProperties(getSpoolerProcess().getOrder()));
