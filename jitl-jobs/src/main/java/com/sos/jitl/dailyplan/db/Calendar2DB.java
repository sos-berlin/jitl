...
public class Calendar2DB {
	...
	public List<DailyPlanDBItem> getStartTimesFromScheduler(Date from, Date to)
		...
		this.from = UtcTimeHelper.convertTimeZonesToDate(fromTimeZoneString, toTimeZoneString,
				new DateTime(from).withZone(fromZone));
		this.to = UtcTimeHelper.convertTimeZonesToDate(fromTimeZoneString, toTimeZoneString,
				new DateTime(to).withZone(fromZone));
