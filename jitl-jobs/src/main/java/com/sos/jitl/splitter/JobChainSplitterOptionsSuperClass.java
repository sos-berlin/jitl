...
/** \class JobChainSplitterOptionsSuperClass - Start a parallel processing in a
 * jobchain
 *
 * \brief An Options-Super-Class with all Options. This Class will be extended
 * by the "real" Options-class (\see JobChainSplitterOptions. The "real" Option
 ...
 * 20130315155436 \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 *
 ...
 * ("		JobChainSplitterOptionsSuperClass.auth_file", "test"); // This parameter
