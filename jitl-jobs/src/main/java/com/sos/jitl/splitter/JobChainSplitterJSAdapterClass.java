...
public class JobChainSplitterJSAdapterClass extends JobSchedulerJobAdapter {
    ...
    private void doProcessing() throws Exception {
        ...
        if (isOrderJob() == true) {
            ...
            // JITL-145: commented to prevent logging of passwords,
            // dirtyString-Method of JSOptionClass calls getAllOptionsAsString
            // which itself aggregates a String with all Options without
            // checking, to log that String can result in clear passwords being
            // logged
            ...
            if (strSyncStateName.length() <= 0) {
                /** If the SyncStateName is not specified the name of the
                 * next_state is used for the sync state */
            ...
            String strSyncParam = strJobChainName + SyncNodeList.CHAIN_ORDER_DELIMITER + strSyncStateName
                    + SyncNodeList.CONST_PARAM_PART_REQUIRED_ORDERS;
