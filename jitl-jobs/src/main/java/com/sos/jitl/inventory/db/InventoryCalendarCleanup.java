...
public class InventoryCalendarCleanup {

    private static final Logger LOGGER = LoggerFactory.getLogger(InventoryCalendarCleanup.class);
    ...
    public static void main(String[] args) throws Exception {
        InventoryCalendarCleanup cleanup = new InventoryCalendarCleanup();
        if (args != null && args.length > 0) {
            ...
            System.out.println("Syntax: java " + InventoryCalendarCleanup.class.getName() + " REPORTING_HIBERNATE_CFG_PATH " + "info");
            System.out.println("OR");
            System.out.println("Syntax: java " + InventoryCalendarCleanup.class.getName() + " REPORTING_HIBERNATE_CFG_PATH "
