    ...
    public JobSchedulerCleanupSchedulerDb Execute() throws Exception {
        ...
        try {
            ...
            if (getOptions().cleanup_daily_plan_execute.isTrue()) {
                DailyScheduleDBLayer dailyScheduleDBLayer = new DailyScheduleDBLayer(getOptions().hibernate_configuration_file.Value());
            ...
            if (getOptions().cleanup_jade_history_execute.isTrue()) {
                JadeFilesDBLayer jadeFilesDBLayer = new JadeFilesDBLayer(getOptions().hibernate_configuration_file.Value());
