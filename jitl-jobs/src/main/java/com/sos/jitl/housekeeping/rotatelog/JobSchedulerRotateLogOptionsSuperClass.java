...
/**
 * \class 		JobSchedulerRotateLogOptionsSuperClass - Rotate compress and delete log files
 *
 * \brief 
 * An Options-Super-Class with all Options. This Class will be extended by the "real" Options-class (\see JobSchedulerRotateLogOptions.
 ...
 * 
 * \verbatim ;
 * mechanicaly created by com/sos/resources/xsl/JSJobDoc2JSOptionSuperClass.xsl from http://www.sos-berlin.com at 20140906131052 
 * \endverbatim
 ...
 * \verbatim
 private HashMap <String, String> SetJobSchedulerSSHJobOptions (HashMap <String, String> pobjHM) {
	pobjHM.put ("		JobSchedulerRotateLogOptionsSuperClass.auth_file", "test");  // This parameter specifies the path and name of a user's pr
		return pobjHM;
 ...
 *
 */
    @JSOptionDefinition(name = "delete_file_age", 
    description = "", 
    key = "delete_file_age", 
    type = "SOSOptionTime", 
    mandatory = false)
 ...
 *
 */
    @JSOptionDefinition(name = "delete_file_specification", 
    description = "", 
    key = "delete_file_specification", 
 ...
 *
 */
    @JSOptionDefinition(name = "file_age", 
    description = "", 
    key = "file_age", 
    type = "SOSOptionTime", 
    mandatory = false)
 ...
 */
    ...
    public SOSOptionTime compress_file_age =
    (SOSOptionTime) file_age.SetAlias(conClassName + ".compress_file_age");
 ...
 *
 */
    @JSOptionDefinition(name = "file_path", 
    description = "", 
    key = "file_path", 
 ...
 *
 */
    @JSOptionDefinition(name = "file_specification", 
    description = "", 
 ...
 */
    ...
    public SOSOptionRegExp compress_file_spec =
    (SOSOptionRegExp) file_specification.SetAlias(conClassName + ".compress_file_spec");
