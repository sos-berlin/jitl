...
public class JobSchedulerRotateLogOptionsSuperClass extends JSOptionsClass {
	...
	/**
	 * \option JobSchedulerID
	 * \type SOSOptionString
	 * \brief JobSchedulerID - The ID of the JobScheduler
	 *
	 * \details
	...
	/**
	 * \var file_age : 
	 * This parameter determines the minimum age at which files will be compressed and saved as archives. 
	 * All files with names following the pattern scheduler-[yyyy-mm-dd-hhMMss].[schedulerId].log and which are 
