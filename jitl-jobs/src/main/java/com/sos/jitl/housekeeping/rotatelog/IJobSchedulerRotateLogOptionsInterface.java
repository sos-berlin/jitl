...
public interface IJobSchedulerRotateLogOptionsInterface {
     ...
     * \details
     *
     * This parameter determines the minimum age at which archived files will be
     * deleted. All files with names that follow the pattern
     ...
     * \details
     *
     * This value of this parameter specifies a regular expression for the log
     * files of the JobScheduler which will be deleted. Changing the default
     * value of this regular expression allows, for example, the log files for a
     * specific JobScheduler to be deleted, should multiple JobSchedulers be
     * logging into the same directory. Note that log files are named according
     * to the pattern scheduler_yyyy-mm-dd-hhmmss.<scheduler_id>.log , where
     ...
     * \details
     *
     * This parameter specifies a directory for the JobScheduler log files. If
     * this parameter is not specified, then the current log directory of the
     * JobScheduler will be used.
     *
     * \return */
     ...
     * \details
     *
     * This parameter specifies a regular expression for the log files of the
     * JobScheduler. Changing the default value of this regular expression
     * allows, for example, the log files for a specific JobScheduler to be
     * rotated, should multiple JobSchedulers be logging into the same
