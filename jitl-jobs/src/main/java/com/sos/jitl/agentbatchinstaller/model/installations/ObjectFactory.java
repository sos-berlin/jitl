...
public class ObjectFactory {
    ...
    private final static QName _SchedulerHome_QNAME = new QName("", "scheduler_home");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "scheduler_home")
    public JAXBElement<String> createSchedulerHome(String value) {
        return new JAXBElement<String>(_SchedulerHome_QNAME, String.class, null, value);
    }
