...
public class StoreResultsJobOptionsSuperClass extends JSOptionsClass {
	...
	public SOSOptionString scheduler_notification_result_parameters = new SOSOptionString(this,
			conClassName + ".scheduler_notification_result_parameters", // HashMap-Key
			"", // Titel
			"", // InitValue
			"", // DefaultValue
			false // isMandatory
	...
	public SOSOptionString scheduler_notification_hibernate_configuration_file = new SOSOptionString(this,
			conClassName + ".scheduler_notification_hibernate_configuration_file", // HashMap-Key
			"", // Titel
			"", // InitValue
			"", // DefaultValue
			false // isMandatory
	...
	public SOSOptionInteger scheduler_notification_connection_transaction_isolation = new SOSOptionInteger(this,
			conClassName + ".scheduler_notification_connection_transaction_isolation", // HashMap-Key
			"", // Titel
			"2", // InitValue
	...
	@JSOptionDefinition(name = "mon_results_order_history_id", description = "", key = "mon_results_order_history_id", type = "SOSOptionInteger", mandatory = false)
	public SOSOptionInteger mon_results_order_history_id = new SOSOptionInteger(this,
			conClassName + ".mon_results_order_history_id", // HashMap-Key
			"", // Titel
			"", // InitValue
			"", // DefaultValue
			false // isMandatory
	...
	public SOSOptionInteger getmon_results_order_history_id() {
		return mon_results_order_history_id;
	}

	public void setmon_results_order_history_id(SOSOptionInteger val) {
		this.mon_results_order_history_id = val;
	}
	...
	public SOSOptionString mon_results_order_step_state = new SOSOptionString(this,
			conClassName + ".mon_results_order_step_state", // HashMap-Key
			"", // Titel
			"", // InitValue
			"", // DefaultValue
			false // isMandatory
	...
	public SOSOptionString mon_results_job_chain_name = new SOSOptionString(this,
			conClassName + ".mon_results_job_chain_name", // HashMap-Key
			"", // Titel
			"", // InitValue
			"", // DefaultValue
			false // isMandatory
