...
@Entity
@Table(name = DBLayer.TABLE_INVENTORY_AGENT_CLUSTER)
@SequenceGenerator(name = DBLayer.TABLE_INVENTORY_AGENT_CLUSTER_SEQUENCE, sequenceName = DBLayer.TABLE_INVENTORY_AGENT_CLUSTER_SEQUENCE, allocationSize = 1)
