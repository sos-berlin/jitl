...
@Entity
@Table(name = DBLayer.TABLE_CLUSTER_CALENDARS)
@SequenceGenerator(name = DBLayer.TABLE_CLUSTER_CALENDARS_SEQUENCE, sequenceName = DBLayer.TABLE_CLUSTER_CALENDARS_SEQUENCE, allocationSize = 1)
public class DBItemInventoryClusterCalendar extends DbItem implements Serializable {
    ...
    /** Primary key */
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = DBLayer.TABLE_CLUSTER_CALENDARS_SEQUENCE)
