...
@Entity
@Table(name = DBLayer.TABLE_INVENTORY_CLUSTER_CALENDAR_USAGE)
@SequenceGenerator(name = DBLayer.TABLE_INVENTORY_CLUSTER_CALENDAR_USAGE_SEQUENCE, sequenceName = DBLayer.TABLE_INVENTORY_CLUSTER_CALENDAR_USAGE_SEQUENCE,
    allocationSize = 1)
public class DBItemInventoryClusterCalendarUsage extends DbItem implements Serializable {
    ...
    /** Primary key */
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = DBLayer.TABLE_INVENTORY_CLUSTER_CALENDAR_USAGE_SEQUENCE)
