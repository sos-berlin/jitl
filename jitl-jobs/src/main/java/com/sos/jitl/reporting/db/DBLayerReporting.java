...
public class DBLayerReporting extends DBLayer {
	...
	public DBItemReportTrigger createReportTrigger(String schedulerId, Long historyId, String name, String title,
			String parentFolder, String parentName, String parentBasename, String parentTitle, String state,
			String stateText, Date startTime, Date endTime, boolean synCompleted, boolean isRuntimeDefined)
			throws Exception {
		try {
	...
	public DBItemReportExecution createReportExecution(String schedulerId, Long historyId, Long triggerId,
			String clusterMemberId, Integer steps, Long step, String folder, String name, String basename, String title,
			Date startTime, Date endTime, String state, String cause, Integer exitCode, Boolean error, String errorCode,
			String errorText, String agentUrl, boolean synCompleted, boolean isRuntimeDefined) throws Exception {
	...
	public DBItemReportVariable createReportVariable(String name, Long numericValue, String textValue)
			throws Exception {
		try {
	...
	public Criteria getStandaloneResultsUncompletedExecutions(Optional<Integer> fetchSize, String schedulerId)
			throws Exception {
		String[] fields = new String[] { "id", "schedulerId", "historyId", "triggerId", "step", "name", "startTime",
				"endTime", "state", "cause", "error", "errorCode", "errorText" };
		Criteria cr = getConnection().createCriteria(DBItemReportExecution.class, fields);
	...
	@SuppressWarnings("unchecked")
	public List<Object[]> getInventoryInfoForTrigger(Optional<Integer> fetchSize, String schedulerId,
			String schedulerHostname, int schedulerHttpPort, String orderId, String jobChainName) throws Exception {
	...
	public List executeCriteriaList(Criteria criteria) throws Exception {
		/**
		 * List result = null; try{ result = criteria.list(); } catch(Exception
		 * e){ Thread.sleep(2_000); result = criteria.list(); } return result;
		 */
	...
	public List executeQueryList(Query q) throws Exception {
		/**
		 * List result = null; try{ result = q.list(); } catch(Exception e){
		 * Thread.sleep(2_000); result = q.list(); } return result;
		 */
		return q.list();
	}
	...
	@SuppressWarnings("unchecked")
	public List<Object[]> getInventoryInfoForExecution(Optional<Integer> fetchSize, String schedulerId,
			String schedulerHostname, int schedulerHttpPort, String jobName, boolean isOrderJob) throws Exception {
	...
	public DBItemReportTriggerResult createReportTriggerResults(String schedulerId, Long historyId, Long triggerId,
			String startCause, Long steps, Boolean error, String errorCode, String errorText) throws Exception {
	...
	@SuppressWarnings("unchecked")
	public DBItemReportExecution getExecution(String schedulerId, Long historyId, Long triggerId, Long step)
			throws Exception {
