...
public class DBItemCalendar extends DbItem implements Serializable {
    ...
    @Column(name = "`BASE_CALENDAR_ID`", nullable = true)
    public void setBaseCalendarId(Long val) {
        this.baseCalendarId = val;
    }
