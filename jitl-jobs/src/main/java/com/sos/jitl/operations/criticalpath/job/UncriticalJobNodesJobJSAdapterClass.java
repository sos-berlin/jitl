...
public class UncriticalJobNodesJobJSAdapterClass extends JobSchedulerJobAdapter  {
	...
	private static Logger logger = LoggerFactory.getLogger(UncriticalJobNodesJobJSAdapterClass.class);

	UncriticalJobNodesJob job = null;
	UncriticalJobNodesJobOptions options = null;
