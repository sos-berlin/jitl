...
public class JobSchedulerSubmitEventJob extends JobSchedulerJobAdapter {
    ...
    private static final String PARAM_SCHEDULER_EXPIRES_TIMEZONE = "scheduler_expires_timezone";
    ...
    protected static void processEvent(final Spooler spooler, final Job spooler_job, final Task spooler_task, final Log spooler_log)
            throws Exception {
        logger = spooler_log;
        ...
        try {
            ...
            if (parameters.var(PARAM_SCHEDULER_EVENT_EXPIRATION_PERIOD) != null && !parameters.var(PARAM_SCHEDULER_EVENT_EXPIRATION_PERIOD)
                    .isEmpty()) {
        ...
        try {
            ...
            for (String strEventID : strA) {
                String addOrder = createAddOrder(eventClass, strEventID, jobChain, orderId, jobName, schedulerHost, schedulerHTTPPort, action,
                        expires, expires_timezone, expCycle, expPeriod, exitCode, eventParameters, supervisorJobChain);
    ...
    private static String createAddOrder(final String eventClass, final String eventId, final String jobChain, final String orderId,
        ...
        try {
            ...
            addParam(paramsElement, "expires_timezone", expires_timezone);
