...
public class JSExistsFileOptionsSuperClass extends JSOptionsClass {
    ...
    public SOSOptionBoolean count_files = new SOSOptionBoolean(this, conClassName + ".count_files",
            "Return the size of resultset If this parameter is set true ", "false", "false", false);
    ...
    @JSOptionDefinition(name = "file_spec", description = "Regular Expression for filename filtering Regular Expression for file fi",
