...
public class JobSchedulerCopyFile extends JobSchedulerFileOperationBase {
	...
	private void doFileOperation(final String strSource, final String strTarget) throws Exception {
		noOfHitsInResultSet += sosFileOperations.copyFileCnt(strSource, strTarget, fileSpec, flags, isCaseInsensitive,
				replacing, replacement, minFileAge, maxFileAge, minFileSize, maxFileSize, skipFirstFiles, skipLastFiles,
