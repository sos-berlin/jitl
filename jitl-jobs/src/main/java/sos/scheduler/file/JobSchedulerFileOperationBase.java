...
public class JobSchedulerFileOperationBase extends JobSchedulerJobAdapter {
    ...
    private void resetVariables() {
        ...
        sosOptionTime = new SOSOptionTime(null, PARAMETER_CHECK_STEADY_STATE_INTERVAL, PARAMETER_CHECK_STEADY_STATE_INTERVAL, "1", "1", false);
    ...
    protected void getParametersFromHashMap() throws Exception {
        ...
        source = file = filePath = getParamValue(new String[] { PARAMETER_SOURCE_FILE, PARAMETER_FILE, PARAMETER_FILE_PATH }, EMPTY_STRING);
        ...
        flags = 0;
        String strCreateWhat = getParamValue(new String[] { PARAMETER_CREATE_DIR, PARAMETER_CREATE_FILE, PARAMETER_CREATE_FILES }, "false");
    ...
    public boolean createResultListParam(final boolean pflgOperationWasSuccessful) {
        ...
        if (spooler_task.order() != null) {
            ...
            if (orderParams != null) {
                ...
                orderParams.set_var(ORDEDR_PARAMETER_SCHEDULER_SOS_FILE_OPERATIONS_RESULT_SET_SIZE, String.valueOf(noOfHitsInResultSet));
            }
