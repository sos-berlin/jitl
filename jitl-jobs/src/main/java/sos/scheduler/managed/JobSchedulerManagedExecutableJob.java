        ...
        try {
            ...
            if (orderPayload != null) {
                ...
                if (orderPayload.var("ignore_error") != null
                        && ("true".equalsIgnoreCase(orderPayload.var("ignore_error")) || "1".equalsIgnoreCase(orderPayload.var("ignore_error"))
                                || "yes".equalsIgnoreCase(orderPayload.var("ignore_error")))) {
                    ignoreError = true;
                }
                if (orderPayload.var("ignore_signal") != null
                        && ("true".equalsIgnoreCase(orderPayload.var("ignore_signal")) || "1".equalsIgnoreCase(orderPayload.var("ignore_signal"))
                                || "yes".equalsIgnoreCase(orderPayload.var("ignore_signal")))) {
                    ignoreSignal = true;
                }
                if (orderPayload.var("ignore_stderr") != null
                        && ("true".equalsIgnoreCase(orderPayload.var("ignore_stderr")) || "1".equalsIgnoreCase(orderPayload.var("ignore_stderr"))
                                || "yes".equalsIgnoreCase(orderPayload.var("ignore_stderr")))) {
                    ignoreStderr = true;
                }
                if (orderPayload.var("ignore_timeout") != null
                        && ("true".equalsIgnoreCase(orderPayload.var("ignore_timeout")) || "1".equalsIgnoreCase(orderPayload.var("ignore_timeout"))
                                || "yes".equalsIgnoreCase(orderPayload.var("ignore_timeout")))) {
                    ignoreTimeout = true;
                }
