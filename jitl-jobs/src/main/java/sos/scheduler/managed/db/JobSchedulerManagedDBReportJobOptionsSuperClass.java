...
public class JobSchedulerManagedDBReportJobOptionsSuperClass extends JSOptionsClass {
    ...
    public SOSOptionBoolean Adjust_column_names = new SOSOptionBoolean(this, conClassName + ".Adjust_column_names",
            "Character conversion for column names", "true", "true", false);
    ...
    @JSOptionDefinition(name = "Column_names_case_sensitivity", description = "Let Column names as is", key = "Column_names_case_sensitivity",
            type = "SOSOptionBoolean", mandatory = false)
    public SOSOptionBoolean Column_names_case_sensitivity = new SOSOptionBoolean(this, conClassName + ".Column_names_case_sensitivity",
            "Let Column names as is", "false", "false", false);
    ...
    public SOSOptionString database_connection = new SOSOptionString(this, conClassName + ".database_connection",
    ...
    public SOSOptionString db_class = new SOSOptionString(this, conClassName + ".db_class", "SOS Connection class", " ", " ", false);
    ...
    public SOSOptionString db_driver = new SOSOptionString(this, conClassName + ".db_driver", "Name of the jd", " ", " ", false);
    ...
    public SOSOptionJdbcUrl db_url = new SOSOptionJdbcUrl(this, conClassName + ".db_url", "jdbc url", "", "", false);
    ...
    @JSOptionDefinition(name = "exec_returns_resultset", description = "If stored proc", key = "exec_returns_resultset", type = "SOSOptionBoolean",
            mandatory = false)
    public SOSOptionBoolean exec_returns_resultset = new SOSOptionBoolean(this, conClassName + ".exec_returns_resultset", "If stored proc", "false",
            "false", false);
    ...
    public SOSOptionInteger Max_No_Of_Records_To_Process = new SOSOptionInteger(this, conClassName + ".Max_No_Of_Records_To_Process",
    ...
    @JSOptionDefinition(name = "scheduler_order_report_asbody", description = "This setting d", key = "scheduler_order_report_asbody",
            type = "SOSOptionBoolean", mandatory = false)
    public SOSOptionBoolean scheduler_order_report_asbody = new SOSOptionBoolean(this, conClassName + ".scheduler_order_report_asbody",
    ...
    @JSOptionDefinition(name = "scheduler_order_report_body", description = "", key = "scheduler_order_report_body", type = "SOSOptionString",
            mandatory = false)
    public SOSOptionString scheduler_order_report_body =
            new SOSOptionString(this, conClassName + ".scheduler_order_report_body", "", " ", " ", false);
    ...
    @JSOptionDefinition(name = "scheduler_order_report_filename", description = "", key = "scheduler_order_report_filename",
            type = "SOSOptionOutFileName", mandatory = false)
    public SOSOptionOutFileName scheduler_order_report_filename = new SOSOptionOutFileName(this, conClassName + ".scheduler_order_report_filename",
    ...
    public SOSOptionString scheduler_order_report_mailbcc = new SOSOptionString(this, conClassName + ".scheduler_order_report_mailbcc",
            "One or more e-", " ", " ", false);
    ...
    @JSOptionDefinition(name = "scheduler_order_report_mailcc", description = "One or more e-", key = "scheduler_order_report_mailcc",
            type = "SOSOptionString", mandatory = false)
    public SOSOptionString scheduler_order_report_mailcc = new SOSOptionString(this, conClassName + ".scheduler_order_report_mailcc",
            "One or more e-", " ", " ", false);
    ...
    @JSOptionDefinition(name = "scheduler_order_report_mailto", description = "report_mailto: recipients of a report",
            key = "scheduler_order_report_mailto", type = "SOSOptionString", mandatory = false)
    public SOSOptionString scheduler_order_report_mailto = new SOSOptionString(this, conClassName + ".scheduler_order_report_mailto",
    ...
    @JSOptionDefinition(name = "scheduler_order_report_path", description = "", key = "scheduler_order_report_path", type = "SOSOptionString",
            mandatory = false)
    public SOSOptionString scheduler_order_report_path =
            new SOSOptionString(this, conClassName + ".scheduler_order_report_path", "", " ", " ", false);
    ...
    @JSOptionDefinition(name = "scheduler_order_report_send_if_no_result", description = "This setting s",
            key = "scheduler_order_report_send_if_no_result", type = "SOSOptionBoolean", mandatory = false)
    public SOSOptionBoolean scheduler_order_report_send_if_no_result = new SOSOptionBoolean(this, conClassName
            + ".scheduler_order_report_send_if_no_result", "This setting s", "false", "false", false);
    ...
    @JSOptionDefinition(name = "scheduler_order_report_send_if_result", description = "This setting s",
            key = "scheduler_order_report_send_if_result", type = "SOSOptionBoolean", mandatory = false)
    public SOSOptionBoolean scheduler_order_report_send_if_result = new SOSOptionBoolean(this, conClassName
            + ".scheduler_order_report_send_if_result", "This setting s", "true", "true", false);
    ...
    @JSOptionDefinition(name = "scheduler_order_report_stylesheet", description = "", key = "scheduler_order_report_stylesheet",
            type = "SOSOptionString", mandatory = false)
