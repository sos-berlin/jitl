...
public class JSBatchInstallerOptionsSuperClass extends JSOptionsClass {
    ...
    public SOSOptionFolderName local_dir = new SOSOptionFolderName(this, conClassName + ".local_dir",
    ...
    public SOSOptionString installation_setup_filename = new SOSOptionString(this, conClassName + ".installation_setup_filename",
