...
public class SyncNodeListJUnitTest {
    ...
    public void testIsReleased() {
        ...
        // 2.Abfrage:
        // <show_job job="/my/synchJob" max_task_history="0"
        // what="job_orders job_chains payload"/>
        // Die Abfrage liefert alle Aufträge inkl. derer Parameter, die am
        // synchJob gerade "hängen".
