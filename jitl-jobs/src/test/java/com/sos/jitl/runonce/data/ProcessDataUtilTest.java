...
public class ProcessDataUtilTest {

    private static final String answerXml =
    ...
    private static final String HIBERNATE_CONFIG_FILE = "/src/test/java/hibernate.cfg.xml";
    private ProcessDataUtil dataUtil = new ProcessDataUtil();
    
    @Test
    public void testGetDataFromJobscheduler() {

    }
    
    @Test
    public void testGetDbmsName() throws Exception {
        String dbmsName = dataUtil.getDbmsName(HIBERNATE_CONFIG_FILE);
        assertEquals("Oracle", dbmsName);
